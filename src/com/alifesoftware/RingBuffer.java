 ...
 *
 * This RingBuffer does not overwrite
 * existing items in the buffer on enqueue
 * operation, and only stores item in the
 * buffer if there is a free, available space
 *
 */
public class RingBuffer<E> {
    ...
    public synchronized boolean enqueue(@NotNull E toSave) {
        ...
        if(isBufferFull()) {
            System.out.println("Buffer is full - return");
            return false;
        }
